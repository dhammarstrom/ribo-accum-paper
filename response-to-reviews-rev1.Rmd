...
author: "Daniel Hammarström, Sjur J. Øfsteng, Nicolai B. Jacobsen, Krister B. Flobergseter, Bent R. Rønnestad, Stian Ellefsen"
date: "2022-01-17"
output: pdf_document
editor_options: 
...
We thank the reviewer for this suggestion, we have incorporated a section connecting our discussion to the emerging field of ribophagy.
...
We thank the reviewer for pointing out the above typos, they have been corrected.
...
Yes, sets were performed with rest periods for the other leg. The protocol still allowed for complete rest between sets ($\sim$ 60 sec) and adjustment of loads if necessary. A clarification has ben added to this section.
...
Muscle tissue from all passes were processed together and aliquots were weighed and frozen. The section has been updated. Unfortunately, a malfunctioning freeze-dryer destroyed a portion of the material. The second aliquot was pooled for RNA extraction when available. 

> Page 14, line 8: Was the spike-in used to normalize RNA extraction efficiency? If yes, please state this clearly.

The spike-in was used to for normalization of rRNA to muscle weight as previously described [hammarström2020]. The section has been updated to notify the reader of the purpose of adding the external reference.

> Page 14, line 49: Does "normalized" refer to denatured?

This refers to diluting all samples to a common protein concentration. The sentence has been updated for clarity.

> Page 15, line 15: Does the authors refer to amplicon size when they write primer sizes?

Yes, the sentence should read amplicon sizes. This has been updated.
...
The figure legends has been updated together with an overall update of figure appearances. 
...
We are greatful for the reviwers kind words.
...
The "%-point difference" referes to a differences in percentage points, i.e. one condition increases in 2% the other 11.2%, the percentage-point difference is 9.2%. This is different from where percentages are stated without the "-point". Although confusing we belive that it is the correct way of reporting this such results.
...
We thank the reviewer for spotting mistakes and suggesting improvements to the text.
...
We thank the reviewer for this suggestion. We agree with the reviwer and feel that the manuscript also communicates this message. This is an important point to underline. We felt that the section served well as part of the mentioned section and added the following:

This may indicate that during the plateau phase, the ribosomal concentration is balanced by muscle growth. This balance, measured as a constant ribosomal density in a growing cell, still requires the biosynthesis of ribosomes to match the volumetric expansion of the cell. As such, indirect measures of translational capacity through the density of ribosomes in periods of marked muscle hypertrophy may mask an absolute increase in ribosomes.
...
The above points has been addressed in the revised manuscript.
