...
Studies examining repeated bouts of resistance exercise suggests that RT leads to accumulation of ribosomes. Bickel *et al*. showed that two subsequent bouts of a hypertrophic stimulus increased total RNA at 72 h after a second bout of RT
[@RN1520]<!-- Total RNA increase 72 h after a secound bout -->.
Following three weeks of RT, Brook et al. reported an increase in total RNA with no further increase after three additional weeks of training
[@RN1642]<!-- Brook 2015 6 week time-course -->.
The findings of Brook et al. fits with observations from our laboratory where we saw a ~30% increase in total RNA per tissue weight after two weeks of RT. Following an additional 10 weeks of RT the RNA content tended to normalized without reaching baseline values (Hammarström et al. 2017 unpublished observation). These data suggests that ribosome accumulation per tissue weight, reaches a plateau in the early phase of RT. Interestingly, in the study by Figueiredo and colleagues, acute exercise in the trained state (after eight weeks of RT), rRNA and pre-rRNA rapidly decreases in response to acute exercise [@RN1644]. 
