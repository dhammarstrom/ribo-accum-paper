...
UBF levels robustly predicted total RNA values with a 1 standard deviation change in UBF levels increasing Total RNA by `r ubf_cor_tot_rna` (Table X). 
