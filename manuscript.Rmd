...
We have previously shown different amounts of training volume in constant volume protocols leads to differences in total RNA and rRNA accumulation in the initial phase of RT [@RN2358].
Based on the notion that ribosomal biogenesis is a complex and tightly regulated, energy demanding process
[@RN1920],<!-- Warner economics of ribosomal biogenesis -->
we hypnotized that fluctuations in training load would reflect in markers of ribosomal biosynthesis reflecting the current need.
Comparing the two volume conditions in the present study we only found one part of the 45S ETS to be differentially expressed at Session 12 in favor of VAR together with a tendency of a rescued UBF level after de-training in response to increased volume in the VAR protocol.
...
It is important to note that RT in the current study was performed with constant volume in the first four sessions, something that could have maximized rRNA transcription in the initial phase.
...
The CONST protocol in the present study corresponded to volumes used in the high volume condition in a previous study from our lab (three sets in two exercises activation knee extensor muscles) [@RN2358].
Compared to a low volume protocol, this led to higher levels of total RNA accumulation [@RN2358].
...
Compared to studies using constant volume protocols
[@RN1809;<!-- Brook 2016 -->
...
This observation was done in well-trained participants performing a high volume protocol without a comparator for volume periodization   
...
Activation of UBF is thought to be controlled by signaling from the mechanosensitive mTOR, pathway as rapamycin, a specific mTOR inhibitor, blocks UBF from recruiting SL1 and subsequent rRNA transcription
[@RN1632; <!-- Nader rapamycin block UBF availability  -->
@RN2564]<!-- Hannan 2003 -->
...
Evidence from human exercise studies confirms training associated activation of UBF through phosphorylation
