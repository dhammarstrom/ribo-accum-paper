...
**Methods:** A training group (n=11) performed unilateral knee extension with constant and variable volume (6 and 3-9 sets per session respectively) allocated to either leg. Vastus lateralis biopsies obtained at rest and 48 hrs after selected training sessions and after eight days of de-training and from a non-training control group (n=7) were assayed for ribosome abundance and biogenesis markers. In addition, muscle thickness was measured before and after training and control periods.
