...
<div custom-style="runningtitle_style">**Short title:** Ribosome biogenesis in early phase resistance training</div>
...
**Aim:** To describe <span custom-style="CHANGE">ribosome biogenesis during resistance training, its relation to training volume and muscle growth</span>.

**Methods:** A training group (n = 11) performed <span custom-style="CHANGE">12 sessions (3-4 sessions per week) of</span> unilateral knee extension with constant and variable volume (6 and 3-9 sets per session respectively) allocated to either leg. <span custom-style="CHANGE">Ribosome abundance and biogenesis markers were assessed from vastus lateralis biopsies obtained at<span custom-style="CHANGE"> baseline, 48 hrs after sessions 1, 4, 5, 8, 9, and 12,</span> and after eight days of de-training, and from a control group (n = 8). Muscle thickness was measured before and after the intervention</span>.

**Results:** Training led to muscle growth (`r hypertrophy` vs. control) with concomitant increases in total RNA, rRNA, UBF, and rpS6 with no differences between volume conditions.<span custom-style="CHANGE"> Total RNA increased rapidly in response to the first four sessions (`r slope0_4` per session), followed by a plateau and peak values after session 8 (`r eight.session` above baseline). Total RNA abundance was associated with UBF protein levels (`r ubf_model` per unit UBF), and the rate of increase in total RNA levels predicted hypertrophy</span> (`r rna_hypertrophy` per %-point increase in total RNA per session). After de-training, total RNA decreased (`r detrain_rna`) without muscle mass changes indicating halted biosynthesis of ribosomes.
...
[@RN1272;@RN1642]<!-- Phillips review 2014 --><!-- Brook 2015 experiment -->. 
...
[@RN1754;@RN2145]<!-- West 2016 correlation between total RNA and protein synthesis in C2C12--><!-- Millward 1973 relationship between RNA and protein synthesis in rat in rats in vivo constant infusion -->
and muscle hypertrophy
[@RN1644;@RN1755;@RN2358].<!-- Figueiredo 2015 Correlation between total RNA fold change and CSA hyp --><!-- Stec Ribosome bio higher in high responders --><!-- Volume dependent RNA accum relates to volume depend hyper -->
...
[@RN1920;@RN1820;@RN1810]<!-- Warner review yeast --><!-- Moss review --><!-- Inhibition of Pol II affects trasncription at Pol I -->.
...
[@RN1632;@RN2564].<!-- Nader rapamycin block UBF availability  --><!-- Hannan mTOR  -->
...
[@RN2225;@RN2180;@RN1656;@RN1520;@RN2358;@RN1755;@RN1644;@RN1809;@RN1897],<!-- Haun 2019 used a progressive volume troughout a six week study study RNA increased during six weeks (12% week 3; 27% week 6 --><!-- Haddad 2005 Unloading through limb suspension leads to lowered total RNA levels, resistance training increased --><!-- Stec2015 A single session ns ~ 9% increase in young, -4% in old --> <!-- Bickel 2005 Two bouts electric stimulation, young ~ 30% incr--><!-- Four sessions ~29 and 18 % in mod vs. low volume|31 sessions 18/12% young--><!-- Stec 2016 12 sessions 26, 9 and 6% increase in high, mod and low responders OLD--><!-- Figuieredo 2015 16 sessions 49% increase young --><!-- Brook 18 sessions 8 and 40% (9 sessions) and 15,22% (18 sessions) old and young--><!-- 11% 36 sessions young -->
...
[@RN1809;@RN2358],
and may be essential for preparing muscle fibres for subsequent growth
[@RN1809;@RN1644;@RN2358].<!-- Correlation between increase and muscle growth --><!--Figueiredo correlation between incr and muscle hypertrophy --><!-- Early accumulation of RNA predicts volume depdent growth -->
...
[@RN1746;@RN1644].<!-- Figueiredo 2016 cold water inhibits UBF activation and increase rRNA increase --> Increases in UBF was determined to be rapamycin insensitive after synergist ablation in mice
...
[@RN2358;@RN1837;@RN791]<!-- Hammarström volume affects ribo biogenesis and mTOR and c-myc --><!-- Ahtianinen 2015 volume affects mTOR differently --><!-- Burd ex volume protein synthesis and anabolic [rpS6] phospho signalling-->,
...
[@RN1767;@RN2492],<!-- schoenfeld 2016 dose response  --><!-- Ralston 2017 Weekly sets volume on muscle strength  -->
...
[@RN1809;@RN2358],<!-- Brook 2016 --><!-- Hammarström 2020 -->
