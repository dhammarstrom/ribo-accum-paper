...
hyp.pre.m2 <- readRDS( "./data/derivedData/ubf-tot-rna-model/hyp_pre_m2.RDS")
hyp.pre.m3 <- readRDS( "./data/derivedData/ubf-tot-rna-model/hyp_pre_m3.RDS")



m1.sum <- summary(hyp.pre.m1)
m2.sum <- summary(hyp.pre.m2)
...
reg_results %>%
  ...
  set_header_labels(coef = "Coefficient", 
                    ...
                    lwr = "Lower 95% CI", 
                    upr = "Upper 95% CI") %>%
    add_header_lines(values = "Table 3. Total RNA as a predictor of muscle growth.") %>%
